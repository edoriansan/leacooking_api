...
INSERT INTO recipe (title, parts, description, img, id_recipe_subcategory) VALUES
    ...
    ('Lasagnes', 4, 'Faire revenir l’oignon... parsemer le plat de fromage râpé.', 'lasagnes.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Chili con carne', 2, 'Émincer l’oignon... Servir avec du riz.', 'chili.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Butter chicken', 2, 'Faire mariner le poulet... Servir avec du riz.', 'butter_chicken.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Poulet aux olives', 2, 'Couper le poulet... Ajouter les olives et servir.', 'poulet_olives.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Empanadas', 15, 'Préparer la pâte... Faire cuire 25 à 30 minutes.', 'empanadas.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Bœuf bourguignon', 4, 'Faire revenir légumes... cuire 3h au total.', 'boeuf_bourguignon.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Blanquette de veau', 4, 'Faire revenir la viande... Ajouter la crème en fin de cuisson.', 'blanquette.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Poulet Basquaise', 4, 'Faire revenir les poivrons... laisser mijoter 45 min.', 'poulet_basquaise.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Tourte à la viande', 8, 'Faire revenir viandes et légumes... Cuire 30 min.', 'tourte_viande.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Hachis Parmentier', 4, 'Préparer purée et viande... gratiner 10 min au four.', 'hachis_parmentier.jpg',(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
    ('Rougail saucisse',2,'Faire revenir l''oignon dans un peu d''huile. Ajouter les bouts de saucisses coupées en morceaux puis la sauce tomate. Terminer en assaisonnant avec des épices et/ou du piment. Laisser mijoter une quinzaine de minutes. Servir avec du riz.',NULL,(SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
