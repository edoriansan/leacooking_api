...
INSERT INTO recipe (title, parts, description, img, id_recipe_subcategory) VALUES
    ...
    ('Pâtes aux poivrons',2,'Faire cuire les poivrons avec l’échalote et un peu d’eau. Mixer les poivrons avec le yaourt et le St Moret. Mélanger la sauce aux pâtes et servir surmonté d’une burrata.',NULL,(SELECT id FROM recipe_subcategory WHERE label = 'Pâtes')),
    ...
    ('Rougail saucisse', 2, 'Faire revenir l’oignon dans un peu d’huile. Ajouter les bouts de saucisses coupées en morceaux puis la sauce tomate. Assaisonner avec des épices et/ou du piment. Laisser mijoter 15 minutes. Servir avec du riz.', 'rougail_saucisse.jpg', (SELECT id FROM recipe_subcategory WHERE label = 'Viande')),
